        ...
        if request.method == "POST":
            try:
                ...
                try:
                     ...
                     weather_data = {"temp":weather.temperature,"pressure":weather.pressure,"Humidity":weather.humidity,"wind":weather.wind,"weather":weather.weather,"main_weather":weather.main_weather,"icon":weather.icon,"time":weather.time, "city":weather.city}
                except:
